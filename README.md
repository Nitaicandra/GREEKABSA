...
after only one epoch of training its able to deterimine positive and negative aspect pairs of accusative and nominative scentences with very high accuracy
|Input|Output|
| ------------- | ------------- |
